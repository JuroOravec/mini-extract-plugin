...
```shell
git clone https://github.com/JuroOravec/mini-extract-plugin.git
cd instance-manager
npm install
```
...
[contributing]: https://github.com/JuroOravec/mini-extract-plugin/blob/master/docs/CONTRIBUTING.md
