[mini-extract-plugin](../README.md) › [SyncLoopHook](syncloophook.md)
...
*Defined in [src/types/hooks-definition.ts:57](https://github.com/JuroOravec/mini-extract-plugin/blob/b97da5f/src/types/hooks-definition.ts#L57)*
