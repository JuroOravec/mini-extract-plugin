[mini-extract-plugin](../README.md) › [SyncBailHook](syncbailhook.md)
...
*Defined in [src/types/hooks-definition.ts:38](https://github.com/JuroOravec/mini-extract-plugin/blob/b97da5f/src/types/hooks-definition.ts#L38)*
