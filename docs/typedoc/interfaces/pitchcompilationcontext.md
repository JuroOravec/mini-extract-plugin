[mini-extract-plugin](../README.md) › [PitchCompilationContext](pitchcompilationcontext.md)
...
*Defined in [src/types/context.ts:44](https://github.com/JuroOravec/mini-extract-plugin/blob/63bec1c/src/types/context.ts#L44)*
